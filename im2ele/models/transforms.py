...
# TODO: this might need to be re-worked
class Scale(object):
...
# Changed to just deal wtih an image (no depth)
...
#     def __call__(self, sample):
#         boost, no_boost, depth = sample['boost'], sample['no_boost'], sample['depth']
#         """
#         Args:
#             pic (PIL.Image or numpy.ndarray): Image to be converted to tensor.
#         Returns:
...
#         # TODO: do these divides need to be here? Check with the paper
#         boost = self.to_tensor(boost)/255
#         no_boost = self.to_tensor(no_boost)/255
#         depth = self.to_tensor(depth)/100000
...
#         return {'boost': boost, 'no_boost': no_boost, 'depth': depth}
