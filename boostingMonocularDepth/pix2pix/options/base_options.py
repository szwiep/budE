import argparse
import os
from boostingMonocularDepth.pix2pix.util import util
import torch
import boostingMonocularDepth.pix2pix.models
import boostingMonocularDepth.pix2pix.data
import numpy as np
...
class BaseOptions():
    ...
    def gather_options(self):
        ...
        model_option_setter = boostingMonocularDepth.pix2pix.models.get_option_setter(model_name)
        parser = model_option_setter(parser, self.isTrain)
        opt, _ = parser.parse_known_args()  # parse again with new defaults

        # modify dataset-related parser options
        dataset_name = opt.dataset_mode
        dataset_option_setter = boostingMonocularDepth.pix2pix.data.get_option_setter(dataset_name)
